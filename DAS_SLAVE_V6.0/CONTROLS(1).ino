//// Definição dos pinos digitais para leitura PWM
//#define pin1 2   // Aileron   (Pino PD2) 
//#define pin2 6   // Profundor (Pino PD6)
//#define pin3 7   // Leme      (Pino PD7)
//#define pin4 8   // Flap      (Pino PB0) 
//
//// DEFLEXÕES MÁXIMAS //
//// Estes valores são definidos pela área de estabilidade e controle
...
//
//// Com exceção deste que é referente ao motor
//#define MAX_THROTTLE 100
//
//// PWMs MÁXIMOS OBTIDOS PELA SAÍDA DO RECEPTOR //
//// Obtenha estes valores pelo primeiro script do site: https://www.theboredrobot.com/post/reading-values-from-an-rc-receiver-using-arduino //
